...
public:
     ...
     * 
     * @param SQW_SEL Extended Crystal Calibration. The frequency generated by the Crystal Oscillator is slowed by 122 ppm times the value in the XTCAL field (0, -122,-244 or -366 ppm).
     * 
     * @return true if function called successfully
     */
    bool IRQClockOut(uint8_t SQW_SEL);

    /**
     * @brief Adjust the XT Calibration register for more precise timekeeping as part of the XT digital calibration process
     * 
     * @param PPM_Adj number of PPM to adjust the clock for possible values are from -610 PPM slower upto 244 PPM faster.
     * 
     * @return true if function called successfully
     */
    bool setPPMAdj(int16_t PPM_Adj);
    ...
    static const uint8_t   REQ_SQW_8192SQWE         = 0xA2;      //!< Square wave output control, enable at 4.096 kHz
    static const uint8_t   REQ_SQW_4096SQWE         = 0xA3;      //!< Square wave output control, enable at 4.096 kHz
    ...
    static const uint8_t   REG_OSC_STATUS_DEFAULT   = 0x22;      //!< Oscillator status default value
    static const uint8_t   REG_OSC_STS_MSK_XTCAL    = 0xc0;      //!< Oscillator status register, extended crystal calibration
